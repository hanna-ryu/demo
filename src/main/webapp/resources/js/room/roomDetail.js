...
submitButton.addEventListener("click", function (ev) {
    ...
    const weekdayCount = document.querySelector(
            ".screens-room-roomDetail__reservation__part-3").children[0].children[1].innerHTML;

    const weekendCount = document.querySelector(
            ".screens-room-roomDetail__reservation__part-4").children[0].children[1].innerHTML;

    const extraPersonCount = document.querySelector(
            ".screens-room-roomDetail__reservation__part-5").children[0].children[1].innerHTML;

    const totalDay = document.querySelector(
            ".screens-room-roomDetail__reservation__part-5").children[0].children[2].innerHTML;
    ...
    location.href = `/room/book/${roomId}`
            ...
            &weekdayCount=${weekdayCount}&weekendCount=${weekendCount}&extraPersonCount=${extraPersonCount}&totalDay=${totalDay}`;
...
document.querySelectorAll(
        ".screens-room-roomDetail__section-3__info-3__desc2-2").forEach(
        textDiv => {
...
btnPlus.addEventListener("click", function (e) {
    ...
    document.querySelector(
            "input[name='booking_num_of_guest']").value = Number(
            inputToggle.value);
